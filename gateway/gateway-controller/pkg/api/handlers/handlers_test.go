...
func createTestMCPStoredConfig(t *testing.T, id, handle, displayName, version, contextPath string, status models.ConfigStatus) *models.StoredConfig {
	t.Helper()
	upstreamURL := "http://backend.example.com"
...
func TestListMCPProxies(t *testing.T) {
	...
	cfg := createTestMCPStoredConfig(t, "0000-mcp-id-0000-000000000000", "test-mcp", "Test MCP", "v1.0.0", "/mcp", models.StatusPending)
...
func TestDeleteMCPProxyWithDBAndEventHub(t *testing.T) {
	...
	cfg := createTestMCPStoredConfig(t, "0000-mcp-delete-id-0000-000000000000", "test-mcp", "Test MCP", "v1.0.0", "/mcp", models.StatusPending)
	require.NoError(t, mockDB.SaveConfig(cfg))
	require.NoError(t, server.store.Add(cfg))
