...
func (s *MCPDeploymentService) UndeployMCPProxy(id, correlationID string, logger *slog.Logger) (*models.StoredConfig, error) {
	...
	updated := *cfg
	updated.Status = models.StatusUndeployed
